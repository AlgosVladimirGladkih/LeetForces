...
// GetTargetWode returns the TreeNode of Val= target
// There must be node in root.Val = target
...
func PreIn2Tree(pre, in []int) *TreeNode {
	if len(pre) != len(in) {
		panic("preIn2Tree The length of the two slices is not equal")
	}
...
// InPost2Tree converts inorder and postorder slices into binary trees
func InPost2Tree(in, post []int) *TreeNode {
	if len(post) != len(in) {
		panic("The length of the two slices in inPost2Tree is not equal")
	}
...
// Tree2Preorder converts a binary tree into a slice of preorder
...
// Tree2Inorder Converts a binary tree into a slice of inorder
...
// Tree2Postorder converts a binary tree into a slice of postorder
...
//Tree2ints Restores *TreeNode to []int according to the line
